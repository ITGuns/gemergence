...
/*
 * Plain-English baseline terms. The free-build ownership model is confirmed:
 * the build vests after six months on any plan, with a buyout available
 * before that (founder, 2026-09-15). Counsel review of this page is still
 * pending. The signed services agreement governs client engagements.
 */
