export const SITE = {
  ...
  // Launch plumbing: FormSubmit until API route + proper sender lands.
  formEndpoint: "https://formsubmit.co/ajax/hello@gemfieldconsulting.com",
  // Open item: business phone. Call paths render only when set (e.g. "+14155550100").
  phone: null as string | null,
  phoneDisplay: null as string | null,
  location: "San Francisco, CA",
  served: "United States",
  // Day-one pixels: set IDs to activate. Nothing renders while null.
  gaId: null as string | null,
  metaPixelId: null as string | null,
  // Open item: social profile URLs (footer + schema sameAs).
